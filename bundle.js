...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _app_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.js */ \"./src/app.js\");\n/* harmony import */ var _about_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./about.js */ \"./src/about.js\");\n/* harmony import */ var _menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu.js */ \"./src/menu.js\");\n/* harmony import */ var _contact_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contact.js */ \"./src/contact.js\");\n/* harmony import */ var _navFooter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./navFooter.js */ \"./src/navFooter.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _img_exterior_jpeg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./img/exterior.jpeg */ \"./src/img/exterior.jpeg\");\n/* harmony import */ var _img_kevin1_jpeg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./img/kevin1.jpeg */ \"./src/img/kevin1.jpeg\");\n/* harmony import */ var _img_menu_png__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./img/menu.png */ \"./src/img/menu.png\");\n\n\n\n\n\n\n\n\n\n\nconst CONTENT = document.querySelector('#content');\n\n\n\n// createFooter();\n\nconst changeHeaderOnScroll = () => {\n    if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {\n        document.querySelector('.main-header').style.opacity = '.5';\n    } else {\n        document.querySelector('.main-header').style.opacity = '1';\n    }\n}\n\nwindow.onscroll = () => {\n    changeHeaderOnScroll();\n}\n\n//call about page \nconst callAboutPage = () => {\n    const about = document.querySelector('.btn-about');\n    about.classList.add('active');\n    return (0,_about_js__WEBPACK_IMPORTED_MODULE_1__.createAboutPage)();\n    // return false;\n}\n\n//call menu page\nconst callMenuPage = () => (0,_menu_js__WEBPACK_IMPORTED_MODULE_2__.createMenuPage)();\n\n//call contact page\nconst callContactPage = () => (0,_contact_js__WEBPACK_IMPORTED_MODULE_3__.createContactPage)();\n\n\n//create header and footer div on main page (Stays for all tabs)\n(0,_navFooter_js__WEBPACK_IMPORTED_MODULE_4__.createHeader)();\n(0,_app_js__WEBPACK_IMPORTED_MODULE_0__.pageLoad)(callAboutPage());\n\n//add active class, removes active btn already has\nconst addActiveClass = (() => {\n    const btns = document.querySelector('.tab-wrapper');\n    const allBtns = btns.getElementsByClassName('tab');\n    for (let i = 0; i < allBtns.length; i++) {\n        allBtns[i].addEventListener('click', (e) => {\n            const target = e.target;\n            const current = btns.getElementsByClassName('active');\n            if (current.length > 0) {\n                current[0].className = current[0].className.replace('active', '');\n            }\n            return target.classList.add('active');\n        })\n    }\n})();\n\nconst changePages = (() => {\n    const btns = document.querySelectorAll('.tab');\n    btns.forEach(btn => {\n        btn.addEventListener('click', (e) => {\n            e.preventDefault();\n\n            const page = document.querySelector('.main-container');\n            page.parentNode.removeChild(page);\n\n            if (btn.textContent === 'Menu') {\n                console.log(btn);\n                callMenuPage();\n            };\n            if (btn.textContent === 'Contact') {\n                console.log(btn);\n                callContactPage();\n            };\n            if (btn.textContent === 'About') {\n                console.log(btn);\n                callAboutPage();\n            };\n        })\n        return false;\n    })\n})();\n\n\n\n//# sourceURL=webpack://restaurantpage/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createHeader\": () => (/* binding */ createHeader),\n/* harmony export */   \"createFooter\": () => (/* binding */ createFooter)\n/* harmony export */ });\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ \"./src/app.js\");\n/* harmony import */ var _about__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./about */ \"./src/about.js\");\n/* harmony import */ var _menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu */ \"./src/menu.js\");\n\n\n\n\nconst mainDiv = document.querySelector('#content');\n\nconst createHeader = () => {\n\n    const mainHeader = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('div', 'main-header').create('header-nav-logo');\n    const btnWrapper = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('div', 'tab-wrapper').create();\n    const btnAbout = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('button', 'tab').create('btn-about');\n    const btnMenu = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('button', 'tab').create('btn-menu');\n    const btnContact = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('button', 'tab').create('btn-contact');\n\n    const anchorAbout = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('a', 'anchorAbout').create();\n\n    const anchorMenu = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('a', 'anchorMenu').create();\n \n    \n    btnAbout.textContent = 'About';\n    btnMenu.textContent = 'Menu';\n    btnContact.textContent = 'Contact';\n\n    btnAbout.type = 'button';\n\n    \n    // anchorAbout.href = '#';\n    // anchorAbout.onclick = 'createAboutPage(); return false';\n\n    // anchorMenu.href = '#';\n    // anchorMenu.onclick = 'createMenuPage(); return false';\n\n\n    const menuOpen = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('button', 'menuOpen').create();\n    const menuIconContainer = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('span', 'menuIconContainer').create();\n\n    const logoDiv = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('div', 'logo-div').create();\n    const logoText = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('p', 'logo-txt').create();\n    logoText.textContent = 'Zammy\\'s';\n    \n    mainDiv.appendChild(mainHeader);\n    mainHeader.append(btnWrapper);\n\n    // btnWrapper.append(anchorAbout);\n    //anchor elements appended to each button \n    // anchorAbout.append(btnAbout);\n    // anchorMenu.append(btnMenu);\n\n    btnWrapper.append(btnAbout);\n    btnWrapper.append(btnMenu);\n    btnWrapper.append(btnContact);\n    mainHeader.append(logoDiv);\n    logoDiv.append(logoText);\n    mainHeader.append(menuOpen);\n    menuOpen.append(menuIconContainer);\n}\n\nconst createFooter = () => {\n    const mainFooter = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('div', 'main-footer').create();\n    const para = new _app__WEBPACK_IMPORTED_MODULE_0__.Element('p', 'footer-text').create();\n    mainDiv.appendChild(mainFooter);\n    mainFooter.append(para);\n}\n\n\n\n//# sourceURL=webpack://restaurantpage/./src/navFooter.js?");

/***/ }),

/***/ "./src/img/exterior.jpeg":
/*!*******************************!*\
  !*** ./src/img/exterior.jpeg ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"eee57c40b1e82e32fd31.jpeg\";\n\n//# sourceURL=webpack://restaurantpage/./src/img/exterior.jpeg?");
...
eval("module.exports = __webpack_require__.p + \"ba205dd43a255a3cf7c6.jpeg\";\n\n//# sourceURL=webpack://restaurantpage/./src/img/kevin1.jpeg?");
...
eval("module.exports = __webpack_require__.p + \"9d5dc285be66039d726d.png\";\n\n//# sourceURL=webpack://restaurantpage/./src/img/menu.png?");
